...
## 2 運営
### 2.1 組織委員会（Organizing Committee）
組織委員会(OC)は，大会を運営します．組織委員会(OC)は，前大会の優勝チームから選出されます．主な役割は，スケジュールやルールを作成し，各競技のシナリオに関する情報をアナウンスすることです．

### 2.2 技術委員会 (Technical Committee)
技術委員会(TC)は，大会の進行をサポートします．技術委員会(TC)各チームから任意で選出されます．主な役割は，各競技のレフェリーや採点作業です．
